...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-[4px] bg-white p-8 shadow-three  sm:p-11 lg:p-8 xl:p-11">
      <h3 className="mb-4 text-2xl font-bold leading-tight text-black ">
        {t("MSGBTN")}
      </h3>
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color">
        {t("SUB")}
      </p>
      <div>
        <input
          ...
          className="border-stroke mb-4 w-full rounded-[4px] border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none focus:border-primary"
        />
        <input
          onChange={(x) => {
            setPayload({
        ...
        <input
          ...
          type="button"
          value={t("SUBBTN")}
          className="mb-5 flex w-full cursor-pointer items-center justify-center rounded-[4px] bg-primary px-9 py-4 text-base font-medium text-white shadow-submit duration-300 hover:bg-primary/90"
        />
