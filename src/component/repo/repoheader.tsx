import {RepoInfo, Repository} from "@/server/types";
                ...
                <div className="repo-header-info-title">
                    ...
                    </div>
                    {
                        (info.fork && info.fork?.owner && info.fork.model) && (
                            <div className="repo-header-info-title-bottom">
                                <span>Forked from </span>
                                <a onClick={() => {
                                    if (info.fork?.owner) {
                                        nav(`/u/${info.fork.owner.username}`)
                                    }
                                }}>
                                    {info.fork.owner.username}
                                </a>
                                <span>/</span>
                                <a onClick={()=>{
                                    if (info.fork?.model && info.fork?.owner) {
                                        nav(`/r/${info.fork.owner.username}/${info.fork.model.name}`)
                                    }
                                }}>
                                    {info.fork.model.name}
                                </a>
                            </div>
                        )
                    }
